...
db_name = os.getenv('DB_NAME', 'stuflow_db')
...
def login():
    ...
    # TEMPORARILY SKIP EMAIL VERIFICATION - Direct login for testing
    token = jwt.encode({
        'user_id': user.id,
        'exp': datetime.utcnow() + timedelta(hours=24)
    }, app.config['SECRET_KEY'], algorithm="HS256")
    ...
    # COMMENTED OUT - Email verification code (uncomment when email is fixed)
    '''
